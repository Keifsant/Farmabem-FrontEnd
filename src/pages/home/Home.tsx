                    ...
                    <div className="flex flex-col gap-4 items-center justify-center py-4">
                        ...
                        <div className="flex justify-around gap-4">
                            ...
                            >
                                ...
                                <span className="w-1/2 drop-shadow-3xl transition-all duration-300 block border-[#B181B1] absolute h-[20%] rounded-tl-lg border-l-2 border-t-2 top-0 left-0"></span>
                                <span className="w-1/2 drop-shadow-3xl transition-all duration-300 block border-[#B181B1] absolute group-hover:h-[90%] h-[60%] rounded-tr-lg border-r-2 border-t-2 top-0 right-0"></span>
                                <span className="w-1/2 drop-shadow-3xl transition-all duration-300 block border-[#B181B1] absolute h-[60%] group-hover:h-[90%] rounded-bl-lg border-l-2 border-b-2 left-0 bottom-0"></span>
